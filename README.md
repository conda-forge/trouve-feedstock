...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/trouve-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/trouve-feedstock)
...
Once the `conda-forge` channel has been enabled, `trouve` can be installed with:

```
conda install trouve
```

It is possible to list all of the versions of `trouve` available on your platform with:
